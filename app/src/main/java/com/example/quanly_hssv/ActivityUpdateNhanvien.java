    ...
    Button btnNo = dialog.findViewById(R.id.buttonNoUpdateStudent);
        ...
        public void onClick(View v) {
            ...
            if(name.equals("") || code.equals("") || birthday.equals("") ){
                Toast.makeText(ActivityUpdateNhanvien.this,"Did not enter enough information",Toast.LENGTH_SHORT).show();
            }
            else {
                database.UpdateStudent(student,id);
                //Khởi tạo lại activity main
                Intent intent = new Intent(ActivityUpdateNhanvien.this, ActivityNhanvien.class);
                intent.putExtra("id_subject",id_subject);
                startActivity(intent);
                Toast.makeText(ActivityUpdateNhanvien.this,"more success",Toast.LENGTH_SHORT).show();
            }
        }
    });
