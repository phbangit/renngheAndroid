...
public class ActivityAddDuan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_duan);
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(subjecttitle.equals("") || credits.equals("") || time.equals("") || place.equals("")){
                    Toast.makeText(ActivityAddDuan.this,"Did not enter enough information",Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    Intent intent = new Intent(ActivityAddDuan.this, ActivityDuan.class);
                    //finish();
                    startActivity(intent);
                    Toast.makeText(ActivityAddDuan.this,"more success",Toast.LENGTH_SHORT).show();
                }
            }
        });
