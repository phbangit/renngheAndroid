...
public class ActivityUpdateDuan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_duan);
    ...
    private void DialogUpdate(int id) {
        ...
        //Nạp layout vào
        dialog.setContentView(R.layout.dialogupdateduan);
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(subjecttitle.equals("") || credits.equals("") || time.equals("") || place.equals("")){
                    Toast.makeText(ActivityUpdateDuan.this,"Did not enter enough information",Toast.LENGTH_SHORT).show();
                }
                else {

                    database.UpdateSubject(subject,id);
                    //Khởi tạo lại activity main
                    Intent intent = new Intent(ActivityUpdateDuan.this, ActivityDuan.class);

                    startActivity(intent);
                    Toast.makeText(ActivityUpdateDuan.this,"more success",Toast.LENGTH_SHORT).show();
                }
            }
        });
