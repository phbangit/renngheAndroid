...
public class ActivityAddNhanvien extends AppCompatActivity {
    ...
    private void DialogAdd(int id_subject) {
        ...
        //Nạp layout vào
        dialog.setContentView(R.layout.dialogaddnhanvien);
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equals("") || code.equals("") || birthday.equals("") || sex.equals("")){
                    Toast.makeText(ActivityAddNhanvien.this,"Did not enter enough information",Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    Intent intent = new Intent(ActivityAddNhanvien.this, ActivityNhanvien.class);
                    //finish();
                    intent.putExtra("id_subject",id_subject);
                    startActivity(intent);
                    Toast.makeText(ActivityAddNhanvien.this,"more success",Toast.LENGTH_SHORT).show();
                }
            }
        });
